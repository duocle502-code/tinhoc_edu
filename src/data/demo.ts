import { Subject, Question, Badge, Achievement, GradeLevel, Exam } from '../types';
...
export const GRADES: GradeInfo[] = [
  { value: 1, label: 'Lớp 1', level: 'primary' },
  { value: 2, label: 'Lớp 2', level: 'primary' },
  { value: 3, label: 'Lớp 3', level: 'primary' },
  { value: 4, label: 'Lớp 4', level: 'primary' },
  { value: 5, label: 'Lớp 5', level: 'primary' },
  ...
  { value: 10, label: 'Lớp 10', level: 'highschool' },
  { value: 11, label: 'Lớp 11', level: 'highschool' },
  { value: 12, label: 'Lớp 12', level: 'highschool' },
];

export const GRADE_LEVELS = {
  primary: { label: 'Tiểu học', grades: [1, 2, 3, 4, 5], color: 'emerald', emoji: '🌱' },
